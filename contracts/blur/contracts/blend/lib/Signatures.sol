...
abstract contract Signatures is ISignatures {
        ...
        )
    {
        ...
        oracleOfferTypehash = keccak256(
            bytes.concat(
                "OracleOffer(", "bytes32 hash,", "uint256 blockNumber", ")"
            )
        );
        ...
        bytes memory feeTypestring =
            bytes.concat("Fee(", "uint16 rate,", "address recipient", ")");
    ...
    function _hashSellOffer(SellOffer calldata offer)
        internal
        view
        returns (bytes32)
    {
    ...
    function _hashOffer(LoanOffer calldata offer)
        internal
        view
        returns (bytes32)
    {
    ...
    function _hashOracleOffer(bytes32 hash, uint256 blockNumber)
        internal
        view
        returns (bytes32)
    {
    ...
    function _hashToSignOracle(bytes32 hash, uint256 blockNumber)
        internal
        view
        returns (bytes32)
    {
